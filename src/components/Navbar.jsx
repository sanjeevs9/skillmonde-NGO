...
export default function Navbar(){
    return (
        ...
        <div className="bg-PPurple flex  bg-opacity-45  ">
            <div><img className="h-10 md:h-14 lg:h-16 lg:pl-10 pl-5  " src={logo} /></div>
            <div className="w-full flex justify-center">
                <div className="flex lg:gap-20 gap-8 md:gap-14  items-center text-white lg:font-medium text-xs lg:text-sm ">
