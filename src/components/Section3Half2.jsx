        ...
        <>
            <div className="">
                <div className="bg-[#f6f4fd] rounded-tl-[6rem] ">
                    <div className="flex flex-col p-2 lg:p-16 gap-5  lg:gap-16  w-full ">
                        <div className="flex flex-col lg:flex-row w-full  items-center  lg:justify-between pl-5 pr-5 gap-5 lg:gap-0">
                        ...
                        <div className="flex flex-col lg:flex-row items-center  lg:justify-between pl-5 pr-5 gap-5 lg:gap-0">
                            <div className="flex flex-col max-w-72 lg:w-60">
